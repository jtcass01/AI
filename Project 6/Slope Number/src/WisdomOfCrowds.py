...
def WOC_start_to_finish(graph_location, log_location, epoch_threshold=25, superiority_tolerance=0.8):
    ...
    uniform_twors = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.UNIFORM, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.TWORS)
    uniform_rsm = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.UNIFORM, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.REVERSE_SEQUENCE_MUTATION)
    partially_mapped_twors = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.PARTIALLY_MAPPED, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.TWORS)
    partially_mapped_rms = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.PARTIALLY_MAPPED, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.REVERSE_SEQUENCE_MUTATION)
    ordered_crossover_twors = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.ORDERED_CROSSOVER, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.TWORS)
    ordered_crossover_rsm = GeneticAlgorithm(graph, population_size=6, crossover_probability=0.8, mutation_probability=0.25, epoch_threshold=epoch_threshold, crossover_method=GeneticAlgorithm.Chromosome.CrossoverMethods.ORDERED_CROSSOVER, mutation_method=GeneticAlgorithm.Chromosome.MutationMethods.REVERSE_SEQUENCE_MUTATION)
...
if __name__ == "__main__":
    WOC_start_to_finish(graph_location=os.getcwd() + os.path.sep + ".." + os.path.sep + "datasets" + os.path.sep + "Random6.tsp", \
                  log_location=os.getcwd() + os.path.sep + ".." + os.path.sep + "results" + os.path.sep + "crowd_" + "Random6_" + datetime.datetime.now().isoformat()[:10] + "_0.csv",
